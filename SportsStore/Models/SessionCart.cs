...
namespace SportsStore.Models
{
    ...
    {
        /*SessionCart class subclasses the Cart class and overrides the AddItem, 
         * RemoveLine, and Clear methods so they call the base implementations and then store the 
